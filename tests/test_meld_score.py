...
class TestMeldScoring(unittest.TestCase):
    ...
    def test_jacks(self):
        ...
        temp_deck += temp_deck
        assert score_meld._jacks(utils.set_trump("Clubs", temp_deck)) == 40
        assert score_meld._jacks(utils.set_trump("Diamonds", temp_deck)) == 40
        assert score_meld._jacks(utils.set_trump("Hearts", temp_deck)) == 40
        assert score_meld._jacks(utils.set_trump("Spades", temp_deck)) == 40
    ...
    def test_pinochle(self):
        ...
        temp_deck += temp_deck
        assert score_meld._pinochle(utils.set_trump("Clubs", temp_deck)) == 30
        assert score_meld._pinochle(utils.set_trump("Diamonds", temp_deck)) == 30
        assert score_meld._pinochle(utils.set_trump("Hearts", temp_deck)) == 30
        assert score_meld._pinochle(utils.set_trump("Spades", temp_deck)) == 30
